...
local SlotNames = {
    ...
    [EQUIPMENT_SLOT_TABARD    ] = {"Tabard",       nil, nil, nil, nil, nil, nil, nil, "Гербовая накидка"},
}
local Locales = {
    {"Update menu", nil, nil, nil, nil, nil, nil, nil, "Обновить меню"},
    {"Remove all transmogrifications", nil, nil, nil, nil, nil, nil, nil, "Очистить все трансмогрификации"},
    {"Remove transmogrifications from all equipped items?", nil, nil, nil, nil, nil, nil, nil, "Очистить все трансмогрификации с одетых вещей"},
    {"Using this item for transmogrify will bind it to you and make it non-refundable and non-tradeable.\nDo you wish to continue?", nil, nil, nil, nil, nil, nil, nil, "Использование этой вещи для трансмогрификации, сделает ее персональной.\nХотите продолжить?"},
    {"Remove transmogrification from %s?", nil, nil, nil, nil, nil, nil, nil, "Удалить трансмогрификацию с %s"},
    {"Back..", nil, nil, nil, nil, nil, nil, nil, "Назад"},
    {"Remove transmogrification", nil, nil, nil, nil, nil, nil, nil, "Удалить трансмогрификацию"},
    {"Transmogrifications removed from equipped items", nil, nil, nil, nil, nil, nil, nil, "Трансмогрификация была удалена с одетых предметов"},
    {"You have no transmogrified items equipped", nil, nil, nil, nil, nil, nil, nil, "У вас нету одетых трансмогрифицированных предметов"},
    {"%s transmogrification removed", nil, nil, nil, nil, nil, nil, nil, "Предмет в слоте %s очищен от трансмогрификации"},
    {"No transmogrification on %s slot", nil, nil, nil, nil, nil, nil, nil, "В слоте %s нет трансмогрификации"},
    {"%s transmogrified", nil, nil, nil, nil, nil, nil, nil, "Предмет в слоте %s трансмогрифицирован"},
    {"Selected items are not suitable", nil, nil, nil, nil, nil, nil, nil, "Выбранные вещи не подходят"},
    {"Selected item does not exist", nil, nil, nil, nil, nil, nil, nil, "Выбранные вещи не существуют"},
    {"Equipment slot is empty", nil, nil, nil, nil, nil, nil, nil, "Этот слот для вещей пуст"},
    {"You don't have enough %ss", nil, nil, nil, nil, nil, nil, nil, "У вас недостаточно %s"},
}
...
local function SuitableForTransmogrification(player, oldItem, newItem)
    ...
    local oldSubClass = newItem:GetSubClass()
...
-- Test code
RegisterPlayerEvent(18, function(e,p,m,t,l) if(m == "#char") then OnGossipHello(e,p,p) return false; end end)
